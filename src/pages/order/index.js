...
import { selectAllOrders, useGetOrdersQuery } from '../../features/orders/ordersApiSlice'
      ...
      <tbody>
        {
          ...
          orders.map((order)=>(
            ...
            <td>{order.orderItems.price * order.orderItems.quantity}</td>
            <td >
            <Status 
            ...
            <td  style={{cursor:"pointer"}}>
              <Link to={`/orders/${order.orderItems._id}`}>
              Info
              </Link>
